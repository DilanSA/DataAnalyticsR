...
#Para este ejercicio utilizaremos la base de datos `CO2` "Carbon Dioxide Uptake in Grass Plants", correspondiente a un experimento sobre la tolerancia al frío de la especie de pasto *Echinochloa crus-galll.*
  
data("CO2") #Importación de dataset
CO2 #Visualización parcial en consola
View(CO2) #Visualización completa en una nueva ventana
...
#Para poder evaluar la frecuencia de dos variables categóricas podemos utilizar tablas de contingencia. Esto lo hacemos con la función `prop.table()`
#Tablas de contingencia para cada combinación de variables categóricas. Valores expresados en porcentajes.
...
#Creación de una tabla que solo contenga las dos variables numéricas de la base de datos CO2
